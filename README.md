# INSTALLATION
 ...
 5. Install further dependencies with `make deps`<br>NOTE: This may require further packages to be installed from your package manager. Read the logs shown if something fails.
